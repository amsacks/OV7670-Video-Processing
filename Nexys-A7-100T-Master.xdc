...
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { i_top_inc_sobel_thresh }]; #IO_L10N_T1_D15_14 Sch=btnr
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { i_top_dec_sobel_thresh }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
